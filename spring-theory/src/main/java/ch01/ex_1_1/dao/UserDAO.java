package ch01.ex_1_1.dao;


import ch01.ex_1_1.domain.User;
...
public class UserDAO {
    ...
    public void add(User user) throws ClassNotFoundException, SQLException {
        ...
        try (
                Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/springtheory", "root", "sdfae342436!");
